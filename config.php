...
define("APP_ID", "2a199cd76df2d615a6fe73be5f4d36b3");
...
define('USER_NAME',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['StaffName'] : null ));
define('USER_EMAIL',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['Emailid'] : null ));
